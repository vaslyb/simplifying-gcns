...
from torch_geometric.nn import GATConv, GCNConv, SAGEConv, SGConv, global_max_pool
...
parser.add_argument('--model', type=str, default='GCN',
                    choices=['GCN', 'GAT', 'SAGE','SGC'])
args = parser.parse_args()

path = osp.join(osp.dirname(osp.realpath(__file__)), '..', 'dataset', 'UPFD')
